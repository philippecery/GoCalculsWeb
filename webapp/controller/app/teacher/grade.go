...
func GradeList(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/list: User session not found")
	}
...
func GradeStudents(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/students: User session not found")
	}
...
func GradeNew(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/new: User session not found")
	}
...
func GradeCopy(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/copy: User session not found")
	}
...
func GradeEdit(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/edit: User session not found")
	}
...
func GradeSave(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/save: User session not found")
	}
...
func GradeDelete(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/delete: User session not found")
	}
...
func GradeUnassign(w http.ResponseWriter, r *http.Request) {
	if httpsession := session.GetSession(w, r); httpsession != nil {
		...
		log.Printf("/teacher/grade/unassign: User session not found")
	}
